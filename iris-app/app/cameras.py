...
def configured_cameras(settings: Settings) -> list[CameraConfig]:
    ...
    cameras = []
    for camera_id, stream_url, public_stream_url, enabled, primary, source_kind, device, serial, model, stable_path in specs:
        ...
        cameras.append(
            CameraConfig(
                ...
                public_stream_url=public_stream_url or None,
                primary=primary,
